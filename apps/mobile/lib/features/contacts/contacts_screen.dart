...
class _ContactsScreenState extends ConsumerState<ContactsScreen> {
  ...
  String _sortLabel(AppLocalizations l10n, ContactSort sort) {
    return switch (sort) {
      ContactSort.createdAtDesc => l10n.contactsSortCreatedDesc,
      ContactSort.createdAtAsc => l10n.contactsSortCreatedAsc,
      ContactSort.nameAsc => l10n.contactsSortNameAsc,
      ContactSort.nameDesc => l10n.contactsSortNameDesc,
    };
  }
        ...
        itemBuilder: (context, index) {
          ...
          return RepaintBoundary(
            child: ContactTile(
              ...
              onTap: () =>
                  context.go('/contacts/${state.contacts[index].id}'),
            ),
          );
        },
      ),
